...
## 1.1 คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 (1) {.smaller}

เมื่อพิจารณาคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 จำนวน 12 ด้าน พบว่าทุกด้านมีค่ามัธยฐานสูงกว่าคะแนนจุดตัดที่ 0.45 คะแนนทั้งหมด บ่งชี้ว่าพฤติกรรมการแสดงออกของนักเรียนส่วนใหญ่มีแนวโน้มสอดคล้องกับคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6
...
## 1.1 คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 (2) {.smaller}
...
## 1.1 คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 (3) {.smaller}
...
## 1.2 สัดส่วนนักเรียนจำแนกตามความสอดคล้องกับคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 {.smaller}
...
## 1.3 รู้จักตรากตรำ : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
...
plot_pyramid_chart(score_hardwork_phrase %>% select(-student_level), 
  ...
  scale_fill_manual(
    values = c(
      "ตั้งใจทำหน้าที่ให้ลุล่วง" = "#C2E1D7", 
      "รับผิดชอบ" = "#389390", 
       "บริหารเวลาอย่างมีประสิทธิภาพ" = "#527c70",
      "เข้มแข็งและอดทน" = "#15392f",
      "ขอความช่วยเหลืออย่างเหมาะสม" = "forestgreen",
      "หลีกเลี่ยงความรับผิดชอบ" = "#d2371f"
    )
  )
...
## 1.3 คุณลักษณะย่อยด้านรู้จักตรากตรำ : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
...
## 1.4 คุณลักษณะย่อยด้านไม่ทำตนเป็นคนถือยศศักดิ์ : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
...
## 1.5 ไม่สำรวยหยิบโหย่ง : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
...
## 1.5 คุณลักษณะย่อยด้านไม่สำรวยหยิบโหย่ง : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
...
## 1.6 เป็นผู้กล้าหาญ : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
...
thai_labels <- c(
  "ตักเตือนอย่างมั่นใจและเหมาะสม",           # Assertive_Correction
  "ใช้ระเบียบควบคุมสถานการณ์",                # Consequential_Accountability
  "เป็นผู้นำที่รับผิดชอบ" ,                    # Responsible_Leadership
"ตอบโต้ด้วยความก้าวร้าว",      # Aggressive_Reaction
  "หลีกเลี่ยงสถานการณ์",          # Avoidant_Behavior
  "ชิลเกินไป / ไม่จริงจัง"         # Over_Relaxing
  )
...
## 1.6 คุณลักษณะย่อยด้านเป็นผู้กล้าหาญ : ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน {.smaller}
