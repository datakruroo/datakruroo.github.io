...
## คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบาย <br> ของรัชกาลที่ 6 ตามการรับรู้ของนักเรียน (1) {.smaller}
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 ตามการรับรู้ของนักเรียน (2) {.smaller}
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 ตามการรับรู้ของนักเรียน (3) {.smaller}
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 ตามการรับรู้ของครู {.smaller}


```{r}
library(gt)
score_teacher_sch %>% 
  inner_join(data_teacher, by = "teacher_id") %>% 
  mutate(attribute = as.character(attribute)) %>%  
  rename(score_value = score) %>% 
  group_by(attribute) %>% 
  summarise(
    n = n(),
    median = median(score_value, na.rm = TRUE),
...
score_teacher_sch %>% 
  rename(score_value = score) %>% 
  mutate(attribute = fct_reorder(attribute, score_value, .fun = median, .na_rm = TRUE)) %>% 
  ggplot(aes(x = score_value, y = attribute)) +
  geom_boxplot(fill = "#4285f4", outlier.alpha = 0) +
  geom_jitter(height = 0.1, alpha = 0.1)+
  geom_vline(xintercept = c(-0.37, 0.45), linetype = 2, color = "grey50")+
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 ตามการรับรู้ของครูจำแนกตามกลุ่มบุคลากร {.smaller}

```{r}
library(tidyverse)
library(tidytext)
temp_teacher <- score_teacher_sch %>% 
  inner_join(data_teacher, by = "teacher_id")

temp_teacher %>% 
  mutate(teacher_category = case_when(
    teacher_category == "บุคลากรเกี่ยวกับกิจกรรมพัฒนาผู้เรียน" ~ "บุคลากร \n เกี่ยวกับ \n กิจกรรม \n พัฒนาผู้เรียน",
    teacher_category == "บุคลากรสายกิจการนักเรียน" ~ "บุคลากรสาย \n กิจการนักเรียน",
    teacher_category == "บุคลากรสายวิชาการ" ~ "บุคลากรสาย \n วิชาการ",
    teacher_category == "บุคลากรเกี่ยวกับกิจกรรมพัฒนาผู้เรียน/ครูพิเศษ)" ~ "บุคลากร \n เกี่ยวกับ \n กิจกรรมพัฒนา \n ผู้เรียน/ครูพิเศษ",
  )) %>% 
  mutate(teacher_category = fct_relevel(teacher_category, 
                                         "บุคลากรสาย \n วิชาการ",
                                         "บุคลากรสาย \n กิจการนักเรียน",
                                          "บุคลากร \n เกี่ยวกับ \n กิจกรรม \n พัฒนาผู้เรียน",
                                          "บุคลากร \n เกี่ยวกับ \n กิจกรรมพัฒนา \n ผู้เรียน/ครูพิเศษ")) %>%
group_by(teacher_category, attribute) %>% 
  summarise(
    n = n(),
    median = median(score, na.rm = TRUE),
    qd = IQR(score, na.rm = TRUE)/2,
  ...
  arrange(desc(median)) %>%
  gt() %>% 
  cols_label(teacher_category = "กลุ่มบุคลากร",
             ...
             q3 = "Q3",
             max = "Max") %>% 
  cols_align(align = "left", columns = c(teacher_category, attribute)) %>%
  fmt_number(columns = everything(),
             decimals = 2) %>%
  tab_options(table.font.size = 12,
              table.width = pct(100),
...
temp_teacher %>% 
  ...
  mutate(teacher_category = fct_relevel(teacher_category, 
                                         ...
                                         "บุคลากรสาย \n กิจการนักเรียน",
                                          "บุคลากร \n เกี่ยวกับ \n กิจกรรม \n พัฒนาผู้เรียน",
                                          "บุคลากร \n เกี่ยวกับ \n กิจกรรมพัฒนา \n ผู้เรียน/ครูพิเศษ")) %>%
  ggplot(aes(x = teacher_category, y = score))+
  geom_boxplot(outlier.alpha = 0, aes(fill = teacher_category))+
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 ตามการรับรู้ของครูจำแนกตามอายุงานของบุคลากร {.smaller}

```{r}
temp_teacher %>% 
  mutate(work_exp = case_when(
    work_exp == "น้อยกว่า 1 ปี" ~ "น้อยกว่า 1 ปี",
    work_exp == "1 ปี แต่ไม่ถึง 2 ปี" ~ "1-6 ปี",
    work_exp == "2 ปี แต่ไม่ถึง 4 ปี" ~ "1-6 ปี",
    work_exp == "4 ปี แต่ไม่ถึง 6 ปี" ~ "1-6 ปี",
    TRUE ~ "6 ปี ขึ้นไป"
  )) %>% 
  mutate(work_exp = fct_relevel(work_exp, "น้อยกว่า 1 ปี", "1-6 ปี", "6 ปี ขึ้นไป")) %>%
  group_by(work_exp, attribute) %>% 
  summarise(
    n = n(),
    median = median(score, na.rm = TRUE),
    qd = IQR(score, na.rm = TRUE)/2,
  ...
  arrange(work_exp, desc(median)) %>% 
  gt() %>%
  cols_label(work_exp = "อายุงานของบุคลากร",
             median = "Med",
             qd = "QD",
             avg = "M",
             sd = "SD",
             ...
             q3 = "Q3",
             max = "Max")  %>% 
  cols_align(align = "left", columns = work_exp) %>%
  fmt_number(columns = everything(),
             decimals = 2)
```
...
library(rcartocolor)
 temp_teacher %>% 
  ...
  mutate(work_exp = fct_relevel(work_exp, "น้อยกว่า 1 ปี", "1-6 ปี", "6 ปี ขึ้นไป")) %>%
  ggplot(aes(x = work_exp, y = score))+
  geom_boxplot(outlier.alpha = 0, aes(fill = work_exp))+
  geom_jitter(width = 0.1, alpha = 0.3, col = "grey20")+
  theme_light()+
  ylab("\n คะแนนคุณลักษณะอันพึงประสงค์\n")+
  xlab("\n อายุงานของบุคลากร")+
  theme(panel.grid = element_blank(),
        ...
        legend.position = "none")+
  facet_wrap(~attribute)+
  scale_fill_carto_d(type = "quantitative", palette = 1)
```

## เปรียบเทียบคะแนนคุณลักษณะอันพึงประสงค์ตามพระราโชบายของรัชกาลที่ 6 ระหว่างนักเรียนและครู {.smaller}

```{r}
combined_student_teacher_sch %>% 
  mutate(type = fct_recode(type, "นักเรียน" = "student",
                           "บุคลากรครู" = "teacher")) %>%
...
combined_student_teacher_sch %>% 
  ...
  geom_jitter(width = 0.1, alpha = 0.1, col = "grey20")+
  theme_light()+
  xlab("")+
  ylab("\n คะแนนคุณลักษณะอันพึงประสงค์\n")+
  theme(panel.grid = element_blank(),
        ...
        legend.position = "none")+
  facet_wrap(~attribute)+
  scale_fill_brewer(type = "qua", palette = "Set2") 
```

## ความสอดคล้องกันระหว่างคะแนนคุณลักษณะอันพึงประสงค์ตามการรับรู้ของนักเรียนและครู {.smaller}


```{r fig.height = 4.5, fig.width =8}
student_dimension <- score_longformat %>% 
  group_by(attribute) %>% 
  reframe(med_score =median(score_value))

teacher_dimension <- score_teacher_sch %>%
  group_by(attribute) %>% 
  reframe(med_score = median(score))

student_dimension %>% 
  inner_join(teacher_dimension, by = "attribute", suffix = c("_student", "_teacher")) %>% 
  summarise(agreement = cor(med_score_student, med_score_teacher, use = "pairwise.complete.obs",
                            method = "pearson"))

student_dimension %>% 
  inner_join(teacher_dimension, by = "attribute", suffix = c("_student", "_teacher")) %>% 
  ggplot(aes(x = med_score_teacher, y = med_score_student)) +
  geom_point()+
  geom_text_repel(aes(label = attribute),
                  family = "ChulaCharasNew")+
  geom_abline(slope = 1, intercept = 0, linetype = 2, color = "grey50") +
  theme_light()+
  xlab("\n มัธยฐานคะแนนคุณลักษณะอันพึงประสงค์ตามการรับรู้ของครู")+
  ylab("\n มัธยฐานคะแนนคุณลักษณะอันพึงประสงค์ตามการรับรู้ของนักเรียน \n")+
  ylim(c(0.5,1))+
  xlim(c(0.5,1))+
  theme(text = element_text(family = "ChulaCharasNew"),
        panel.grid = element_blank())
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการตามการรับรู้ของนักเรียน (1) {.smaller}
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการตามการรับรู้ของนักเรียน (2) {.smaller}
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการตามการรับรู้ของนักเรียน (3) {.smaller}
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการตามการรับรู้ของครู {.smaller}


```{r}
library(gt)
score_teacher_academic %>% 
  inner_join(data_teacher, by = "teacher_id") %>% 
  mutate(attribute = as.character(attribute)) %>%  
  rename(score_value = score) %>% 
  group_by(attribute) %>% 
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการตามการรับรู้ของครู จำแนกตามกลุ่มบุคลากร {.smaller}


```{r}
library(tidyverse)
library(tidytext)
temp_teacher <- score_teacher_academic %>% 
  inner_join(data_teacher, by = "teacher_id")
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการตามการรับรู้ของครู จำแนกตามอายุงานของบุคลากร {.smaller}
...
## เปรียบเทียบคะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการ ระหว่างนักเรียนและครู {.smaller}

```{r}
combined_student_teacher_academic %>% 
  mutate(type = fct_recode(type, "นักเรียน" = "student",
                           "บุคลากรครู" = "teacher")) %>%
  group_by(type, attribute) %>% 
  summarise(
...
## ความสอดคล้องกันระหว่างคะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายวิชาการ ตามการรับรู้ของนักเรียนและครู {.smaller}


```{r fig.height = 4.5, fig.width =8}
student_dimension <- score_longformat_academic %>% 
  group_by(attribute) %>% 
  reframe(med_score =median(score_value))

teacher_dimension <- score_teacher_academic %>%
  group_by(attribute) %>% 
  reframe(med_score = median(score))
...
## คะแนนคุณลักษณะอันพึงประสงค์ตามหลักสูตรแกนกลางที่รับผิดชอบโดยฝ่ายกิจการนักเรียน ตามการรับรู้ของครู {.smaller}
...
library(tidyverse)
library(tidytext)
temp_teacher <- score_teacher_student %>% 
  inner_join(data_teacher, by = "teacher_id")
...
```{r fig.height = 6}
library(ggrepel)
combined_student_teacher_student %>% 
  mutate(type = fct_recode(type, "นักเรียน" = "student",
                           "บุคลากรครู" = "teacher")) %>%
  ggplot(aes(x = type, y = score))+
  geom_boxplot(aes(fill = type), outlier.alpha = 0)+
...
```{r fig.height = 4.5, fig.width =8}
student_dimension <- score_longformat_student %>% 
  group_by(attribute) %>% 
  reframe(med_score =median(score_value))

teacher_dimension <- score_teacher_student %>%
  group_by(attribute) %>% 
  reframe(med_score = median(score))
