...
## การคำนวณคะแนนคุณลักษณะอันพึงประสงค์ของนักเรียนวชิรวุธ
...
## 1.3 ผลการวิเคราะห์ลักษณะของพฤติกรรมจากข้อความของนักเรียน : รู้จักตรากตรำ {.smaller}


- ผู้วิจัยคัดกรองข้อความที่มีความสอดคล้อง/ไม่สอดคล้องกับคุณลักษณะอันพึงประสงค์ด้านรู้จักตรากตรำ โดยใช้คะแนนจุดตัดเป็นเกณฑ์ 

- จากนั้นใช้โมเดลภาษาขนาดใหญ่ช่วยระบุคุณลักษณะย่อยของพฤติกรรมที่แสดงออกในแต่ละข้อความ
...
```{r distribution_plot, fig.width = 8, echo = F}
library(rcartocolor)
...
thai_labels <- c(
  "ทุ่มเทอย่างสมดุล",
  "รับผิดชอบอย่างขยันขันแข็ง",
  "บริหารเวลาที่มีประสิทธิภาพ",
  "ยืดหยุ่นและอดทนต่ออุปสรรค",
  "หาความช่วยเหลืออย่างเหมาะสม",
  "หลีกเลี่ยง"
)
...
plot_pyramid_chart(score_hardwork_phrase %>% select(-student_level), 
  ...
  scale_fill_manual(
    values = c(
      "ทุ่มเทอย่างสมดุล" = "#C2E1D7", 
      "รับผิดชอบอย่างขยันขันแข็ง" = "#389390", 
      "บริหารเวลาที่มีประสิทธิภาพ" = "#527c70",
      "ยืดหยุ่นและอดทนต่ออุปสรรค" = "#15392f",
      "หาความช่วยเหลืออย่างเหมาะสม" = "forestgreen",
      "หลีกเลี่ยง" = "#d2371f"
    )
  )
...
```{r data_preprocessing_respect, echo = F, eval = F}
