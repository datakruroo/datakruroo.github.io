...
# What is dimensionality reduction? {.smaller}
...
- กระบวนการลดจำนวนมิติ (features หรือ variables) ในชุดข้อมูล โดยยังคงข้อมูลที่สำคัญที่สุดไว้เพื่อให้โมเดลยังสามารถทำงานได้อย่างมีประสิทธิภาพมากขึ้น
