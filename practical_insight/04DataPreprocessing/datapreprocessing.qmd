...
1.  **การแปลงข้อมูลให้เป็นค่ามาตรฐาน (standardization)** เป็นการแปลงให้ข้อมูลเชิงปริมาณใด ๆ อยู่ในสเกลมาตรฐานที่มีค่าเฉลี่ยเท่ากับ 0 และส่วนเบี่ยงเบนมาตรฐานเท่ากับ 1 ด้วยสูตร $Z = \frac{X-\bar{X}}{SD}$
2.  **การแปลงข้อมูลให้เป็นค่าปกติ (normalization)** เป็นการแปลงข้อมูลเชิงปริมาณใด ๆ ให้มีค่าอยู่บนช่วงปิด [0,1] ด้วยสูตร $N = \frac{X-Min}{Max-Min}$

## Transforming Data {.smaller}


3.  **Box-Cox และ Yeo-Johnson transformation** เป็นวิธีการแปลงข้อมูลเพื่อแก้ปัญหาความเบ้หรือค่าผิดปกติที่เกิดขึ้นในชุดข้อมูล โดย Box-Cox transformation มีเงื่อนไขสำคัญคือสามารถใช้ได้กับข้อมูลที่มีพิสัยเป็นจำนวนจริงบวก สูตรการแปลงข้อมูลของ Box-Cox เป็นดังนี้
