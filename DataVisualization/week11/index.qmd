...
legend(x = -2.13, y= -0.5,  # position of the legend
...
คราวนี้ลองสร้างแผนภาพเดิมด้วย ggraph จะเห็นว่าการสร้าง การ mapping attribute การปรับแต่งและการทำซ้ำ ทำได้ง่ายกว่า igraph อย่างไรก็ตาม ggraph จะไม่ได้ theme เดียวกับ igraph
...
g %>% 
  ...
  geom_edge_link(aes(linewidth = num_thesis),
                 edge_color = "grey90")+
  geom_edge_link(arrow = arrow(type = "closed", length = unit(0.08, "inches")),
