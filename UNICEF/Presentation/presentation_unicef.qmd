...
## 3.2.2 Insight Results: Importance Variables {.smaller}

<div style="font-size: 75%;">


- The researchers analyzed the relationship between non-climate factors and the CMER Index, categorized by educational service areas, using regularized regression. The analysis revealed that each area has different non-climate factors associated with the CMER Index, indicating varying contexts between regions. Initially, the researchers selected the most significant factor for each area for further analysis.
