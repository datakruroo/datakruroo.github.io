...
สมมุติว่าเราต้องการทำนายเกรด `G3` ของนักเรียน

- การทำนายด้วย Single learner แบบดั้งเดิม เช่น linear regresion หรือ decision tree หรืออื่น ๆ จะพยายามสร้างโมเดลเดียวที่ดีที่สุด ที่ครอบคลุมสามารถใช้ได้กับข้อมูลทั้งหมด 

```
G3 ~ G2 + studytime + failures + absences + ...
``

ปัญหาคือโมเดลนี้อาจใช้ได้ดีกับนักเรียนส่วนหนึ่ง แต่อาจจะใช้ไม่ได้ดีกับนักเรียนอีกหลายคน
