...
\newfontfamily{\thaifont}[Scale=MatchUppercase,Mapping=textext, SizeFeatures={Size=10}]{ChulaCharasNew}
...
%% ---- Spacing ---- %%
\renewcommand{\baselinestretch}{1.2} % Line Spacing (1.5 is recommended for Thai language)
...
\AtBeginDocument\captionsthai % allow captions to be in Thai
% ฟอนต์ CHULALONGKORN ต้องติดตั้งในระบบแล้ว
\newfontfamily\chulafont[Scale=MatchUppercase]{CHULALONGKORN} % ใช้ฟอนต์ Chulalongkorn สำหรับหัวข้อ

%% ---- การปรับแต่ง header (section) และ subsection ---- %%
\usepackage{titlesec}
\usepackage{xcolor}

% ปรับแต่งฟอนต์ สี และขนาดสำหรับ \section (หัวข้อใหญ่)
\titleformat{\section}
  {\normalfont\chulafont\Huge\color{blue}} % ฟอนต์ CHULALONGKORN สีฟ้า ขนาดใหญ่
  {\thesection}{1em}{}

% ปรับแต่งฟอนต์ สี และขนาดสำหรับ \subsection (หัวข้อย่อย)
\titleformat{\subsection}
  {\normalfont\chulafont\LARGE\color{red}}  % ฟอนต์ CHULALONGKORN สีแดง ขนาดรองลงมา
  {\thesubsection}{1em}{}
