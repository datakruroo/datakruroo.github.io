...
create_complete_dataset <- function() {
  ...
  complete_data <- course_clo_subplo %>%
    left_join(keywords_data, by = "subplo_id", relationship = "many-to-many") %>%
...
# ==================== 8. ฟังก์ชันสร้างข้อมูลสำหรับ Heatmap ====================
...
# ==================== 9. ฟังก์ชันสร้างข้อมูล Keywords summary ====================
...
cat("# Sankey data: ต้อง source('sankey.r') ก่อน\n")
...
# ==================== 11. ฟังก์ชันคำนวณตัวชี้วัดทางสถิติ ====================
...
# 3. Balance Analysis - การวิเคราะห์ความสมดุล
...
# 4. Strategic Importance Analysis - การวิเคราะห์ความสำคัญเชิงกลยุทธ์
...
cat("\n✅ ข้อมูลและฟังก์ชัน metrics พร้อมใช้งาน!\n")
cat("📌 สำหรับ Sankey Diagram ให้ run: source('sankey.r')\n")
cat("📊 สำหรับ metrics analysis ให้ run: metrics_analysis <- generate_metrics_summary(complete_dataset)\n")
