...
courses <- tibble(
  ...
  course_name_th = c(
    ...
    "การประเมินคว# การสร้างและตรวจสอบข้อมูล ====================
...
# หมายเหตุ: ฟังก์ชัน create_sankey_data อยู่ในไฟล์ sankey.r
...
# ==================== 9. ฟังก์ชันคำนวณตัวชี้วัดทางสถิติ ====================
...
print(head(metrics_analysis$strategic$course_strategic %>% 
           select(course_short, strategic_score, importance_category), 5))

cat("\nTop 5 High-Impact Keywords:\n") 
print(head(metrics_analysis$strategic$high_impact_keywords %>%
           select(keyword, keyword_score, course_reach, impact_category), 10))
